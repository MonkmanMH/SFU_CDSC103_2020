...
This example uses data provided by Statistics Canada, with household income by household type from the 2016 Census. See [](..\scr\census_data_sources.Rmd) for more information. 
...
Insert an R chunk and rerun the example above, but with the `Member ID: Household type including census family structure (11)` variable set to factor.
...
read_csv(here("data", "98-400-X2016100_ENG_CSV", "98-400-X2016100_English_CSV_data.csv"),
                               col_types =
                                 cols(`Member ID: Household type including census family structure (11)` = col_factor()))
